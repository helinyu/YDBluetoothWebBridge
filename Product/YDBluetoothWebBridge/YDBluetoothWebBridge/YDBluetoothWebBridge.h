...
//! Project version number for YDBluetoothWebBridge.
FOUNDATION_EXPORT double YDBluetoothWebBridgeVersionNumber;

//! Project version string for YDBluetoothWebBridge.
FOUNDATION_EXPORT const unsigned char YDBluetoothWebBridgeVersionString[];
